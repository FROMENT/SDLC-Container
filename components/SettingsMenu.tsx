...
import { Sun, Moon, Monitor, Globe, ChevronDown, Check } from 'lucide-react';
...
export const SettingsMenu: React.FC<Props> = ({ currentTheme, onThemeChange, currentLang, onLangChange, translate }) => {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      >
        {getThemeIcon()}
        <span className="hidden sm:inline text-xs font-medium uppercase tracking-wider">{t('Settings')}</span>
        ...
        <div className="absolute right-0 mt-2 w-56 rounded-xl bg-white dark:bg-card-bg border border-gray-200 dark:border-gray-700 shadow-xl z-50 overflow-hidden animate-fade-in">
          ...
          <div className="p-2 border-b border-gray-100 dark:border-gray-800">
            ...
            <div className="space-y-1">
              {[
                { id: 'light', icon: Sun, label: t('Light (High Contrast)') },
